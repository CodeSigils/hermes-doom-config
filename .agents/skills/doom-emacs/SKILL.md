...
| `validate-docs.py`           | Run all 13 doc-health checks (stale guidance, references, scripts, domains, sections, snippets, pipes, frontmatter, module alignment, cross-commit drift) | Called by `check-stale-patterns.sh`                  |
