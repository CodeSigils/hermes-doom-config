...
| `validate-docs.py`           | Run all 14 doc-health checks (stale guidance, references, scripts, domains, sections, snippets, pipes, frontmatter, module alignment, functions, cross-commit drift) | Called by `check-stale-patterns.sh`                  |
