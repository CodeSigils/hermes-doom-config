...
| 2 — references/        | `references/jinx.md`                                   | Jinx spell-checking reference — config, dictionaries, verification       | SKILL.md Quick Index, INDEX.md SS12      |
| 2 — references/        | `references/snippet-validation.md`                     | Yasnippet parser-level validation — directives, tab-stop semantics       | SKILL.md Quick Index, INDEX.md SS12      |
...
| ----------------------------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Do automatically                    | Routine maintenance within documented patterns                          | Comment/uncomment modules in `init.el`, add `package!` to `packages.el`, add custom functions with `user/` prefix, run `doom sync` + `doom doctor`, **sync the runtime mirror after editing skill or domain files** |
...
| `references/jinx.md`                  | `AGENTS.md` Reference Map, `SKILL.md` Quick Index, `SKILL.md` Reference Sources                             | Add/remove rows, update paths, register in Reference Map                                                       |
| `references/snippet-validation.md`    | `AGENTS.md` Reference Map, `SKILL.md` Quick Index, `SKILL.md` Reference Sources                             | Add/remove rows, update paths, register in Reference Map                                                       |
